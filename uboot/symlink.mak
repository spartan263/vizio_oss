...
#	@for i in `cd $(VM_LINUX_ROOT)/project_x/middleware/; ls *.mak`; do \
		$(call if_file_notexist_w_sym_fct, $(VM_LINUX_ROOT)/project_x/middleware/$$i         ,$(MTKLOADER_ROOT)/middleware/$$i); \
	done
#	@for i in `cd $(VM_LINUX_ROOT)/project_x/middleware/scripts/; ls`; do \
		$(call if_file_notexist_w_sym_fct, $(VM_LINUX_ROOT)/project_x/middleware/scripts/$$i ,$(MTKLOADER_ROOT)/middleware/scripts/$$i); \
	done

#	@for i in `cd $(VM_LINUX_ROOT)/project_x/middleware/dlm/; ls`; do \
		$(call if_file_notexist_w_sym_fct, $(VM_LINUX_ROOT)/project_x/middleware/dlm/$$i      ,$(MTKLOADER_ROOT)/middleware/dlm/$$i); \
	done
