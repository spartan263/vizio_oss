...
#if defined(CC_MT5881) || defined(CC_MT5395) || defined(CC_MT5396) || defined(CC_MT5368) || defined(CC_MT5389) || defined(CONFIG_ARCH_MT5398) || defined(CONFIG_ARCH_MT5880)
#define IO_BASE_USB                                    (0xf0000000)
#else
#define IO_BASE_USB                                    (0x20000000)
#endif


#if defined(CC_MT5396) || defined(CC_MT5881) || defined(CC_MT5389) || defined(CONFIG_ARCH_MT5398) || defined(CONFIG_ARCH_MT5880)
...
#define MUSB_BASE                   (IO_BASE_USB + 0x29000)
#define MUSB_BASE1                  (IO_BASE_USB + 0x2E000)
    #define MUSB_COREBASE            (0)  
    #define MUSB_PHYBASE             (0x00400)
        #define MUSB_PORT0_PHYBASE       (0)
	#define MUSB_PORT1_PHYBASE       (0)

// Modify USB_ADDR to support multiple port usb.
#define USB_ADDR	        				((UINT32)mtkusbport[u4Port].pBase)
...
#define MOTG_MISC_REG_READ32(r)\
    *((volatile UINT32 *)(((UINT32)mtkusbport[u4Port].pBase) + USB_MISC_OFFSET +(r)))

#define MOTG_MISC_REG_WRITE32(r, v)\
    *((volatile UINT32 *)(((UINT32)mtkusbport[u4Port].pBase) + USB_MISC_OFFSET + (r))) = v

#define MOTG_REG_READ8(r)\
    *((volatile UINT8 *)(((UINT32)mtkusbport[u4Port].pBase) + USB_BASE_OFFSET + (r)))

#define MOTG_REG_WRITE8(r,v)\
    do {\
    volatile UINT32 temp; \
    temp = *((volatile UINT32 *)(((UINT32)mtkusbport[u4Port].pBase) + USB_BASE_OFFSET + ((r) & 0xFC))); \
    temp &= ~(0xFF << (8*((r) & 0x03)));\
    temp |= (volatile UINT32)((v) << (8*((r) & 0x03)));\
    *((volatile UINT32 *)(((UINT32)mtkusbport[u4Port].pBase) + USB_BASE_OFFSET + ((r) & 0xFC))) = temp; \
    }while(0)

#define MOTG_REG_READ16(r)\
    *((UINT16 *)(((UINT32)mtkusbport[u4Port].pBase) + USB_BASE_OFFSET + (r)))
...
#define MOTG_REG_READ32(r)\
    *((volatile UINT32 *)(((UINT32)mtkusbport[u4Port].pBase) + USB_BASE_OFFSET + (r)))

#define MOTG_REG_WRITE32(r,v)\
    *((volatile UINT32 *)(((UINT32)mtkusbport[u4Port].pBase) + USB_BASE_OFFSET + (r))) = v

#define FIFO_ADDRESS(e)\
    (((UINT32)mtkusbport[u4Port].pBase) + (USB_BASE_OFFSET) + (e<<2) + M_FIFO_EP0)
