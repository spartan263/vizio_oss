...
#include "mt5398_mac.h"
#include "../include/configs/mt5398.h"
#include "c_model.h"
...
int MmacDmaInit( Mmac *dev, TxDesc *tdesc, RxDesc *rdesc )
{
	...
	dev->txdesc = (TxDesc *)(((u32)tdesc | 0x80000000) & (~(DMA_ALIGN_SIZE-1)));
    TR("txdesc : 0x%08x\n",(u32)dev->txdesc);
	dev->rxdesc = (RxDesc *)(((u32)rdesc | 0x80000000) & (~(DMA_ALIGN_SIZE-1)));
    TR("rxdesc : 0x%08x\n",(u32)dev->rxdesc);
