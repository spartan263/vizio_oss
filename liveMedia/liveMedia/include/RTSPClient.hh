...
public:
  ...
  int socketNum() const { return fInputSocketNum; }
    ...
    // move by wen.tang: from private func -> public func  (for WFD TCP connection)
  int openConnection(); // -1: failure; 0: pending; 1: success
    // add by wen.tang: for receive source request
...
protected:
  ...
  // Marked by wen.tang: move to public func  (for WFD TCP connection)
//  int openConnection(); // -1: failure; 0: pending; 1: success
...
protected: // used to implement the old interface:
