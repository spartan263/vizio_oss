...
#define NORMAL_PINMUX_BITS      160
#define TOTAL_PINMUX_BITS       (NORMAL_PINMUX_BITS + 32 + 1)

#define NORMAL_GPIO_NUM         192
#define TOTAL_OPCTRL_NUM        13
#define TOTAL_GPIO_NUM          (NORMAL_GPIO_NUM + 8 + TOTAL_OPCTRL_NUM)
#define TOTAL_GPIO_IDX          ((NORMAL_GPIO_NUM + 31) >> 5)
#define GPIO_INDEX_MASK         ((1 << 5) - 1)
#define GPIO_TO_INDEX(gpio)     (((UINT32)(gpio)) >> 5)

#define GPIO_EDGE_INTR_NUM      27
