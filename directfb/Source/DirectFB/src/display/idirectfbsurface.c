...
extern void mt53FlushReadCache( void *driver_data, void *device_data );
                                ...
                                int x, int y, int w, int h )
{
     ...
     static int number = 0;
	 if(dfb_enable_dump(3))
	 {
		  dfb_dump_surface(data->surface, CSBR_BACK, "fillrec_1_dst", number);
		  D_DEBUG_AT( Surface, "---> [num = %d] DST[%p] \n", number, data->surface);
		  D_DEBUG_AT( Surface, "---> [num = %d] drawingflags=0x%x \n", number, data->state.drawingflags);
		  D_DEBUG_AT( Surface, "---> [num = %d] src_blend=0x%x \n", number, data->state.src_blend);
		  D_DEBUG_AT( Surface, "---> [num = %d] dst_blend=0x%x \n", number, data->state.dst_blend);
		  D_DEBUG_AT( Surface, "---> [num = %d] ARGB=0x%x \n", number, PIXEL_ARGB(data->state.color.a, data->state.color.r, data->state.color.g, data->state.color.b));
		  D_DEBUG_AT( Surface, "---> [num = %d] DST:PixelFormat=0x%x \n", number, data->surface->config.format);
		  D_DEBUG_AT( Surface, "---> [num = %d] DST:ConfigFlags=0x%x \n", number, data->surface->config.flags);	
		  D_DEBUG_AT( Surface, "---> [num = %d] DST:caps=0x%x \n", number, data->surface->config.caps);			  
	 }
#endif	 
	 ...
	 if(dfb_enable_dump(3))
	 {
         dfb_dump_surface(data->surface, CSBR_BACK, "fillrec_2_dst", number);
		 number++;
	 }
#endif
                                ...
                                int x, int y, int w, int h )
{
...
#ifdef CC_DFB_DEBUG_SUPPORT
     static int number = 0;
	 if(dfb_enable_dump(4))
	 {
		  dfb_dump_surface(data->surface, CSBR_BACK, "drawrec_1_dst", number);
		  D_DEBUG_AT( Surface, "---> [num = %d] DST[%p] \n", number, data->surface);
		  D_DEBUG_AT( Surface, "---> [num = %d] drawingflags=0x%x \n", number, data->state.drawingflags);
		  D_DEBUG_AT( Surface, "---> [num = %d] src_blend=0x%x \n", number, data->state.src_blend);
		  D_DEBUG_AT( Surface, "---> [num = %d] dst_blend=0x%x \n", number, data->state.dst_blend);
     ...
     CoreGraphicsStateClient_DrawRectangles( &data->state_client, &rect, 1 );
		  ...
		  if(dfb_enable_dump(4))
		  {
			  dfb_dump_surface(data->surface, CSBR_BACK, "draw_2_dst", number);
			  number++;
		  }
#endif
                                 ...
                                 unsigned int        num_rects )
{
	 ...
	 if(dfb_enable_dump(3))
	 {
		  dfb_dump_surface(data->surface, CSBR_BACK, "fillrecs_1_dst", number);
		  D_DEBUG_AT( Surface, "---> [num = %d] DST[%p] \n", number, data->surface);
		  D_DEBUG_AT( Surface, "---> [num = %d] drawingflags=0x%x \n", number, data->state.drawingflags);
		  D_DEBUG_AT( Surface, "---> [num = %d] src_blend=0x%x \n", number, data->state.src_blend);
		  D_DEBUG_AT( Surface, "---> [num = %d] dst_blend=0x%x \n", number, data->state.dst_blend);
	 ...
	 if(dfb_enable_dump(3))
	 {
         dfb_dump_surface(data->surface, CSBR_BACK, "fillrecs_2_dst", number);
		 number++;
	 }
#endif	 
                       ...
                       int dx, int dy )
{
...
#ifdef CC_DFB_DEBUG_SUPPORT
     static int number = 0;
	 if(dfb_enable_dump(0))
	 {
	      dfb_dump_surface(src_data->surface, CSBR_FRONT, "blit_src", number);
		  dfb_dump_surface(data->surface, CSBR_BACK, "blit_1_dst", number);
		  D_DEBUG_AT( Surface, "---> [num = %d] SRC[%p] DST[%p] \n", number, src_data->surface, data->surface);
		  D_DEBUG_AT( Surface, "---> [num = %d] blittingflags=0x%x \n", number, data->state.blittingflags);
		  D_DEBUG_AT( Surface, "---> [num = %d] src_blend=0x%x \n", number, data->state.src_blend);
		  D_DEBUG_AT( Surface, "---> [num = %d] dst_blend=0x%x \n", number, data->state.dst_blend);
		  D_DEBUG_AT( Surface, "---> [num = %d] ARGB=0x%x \n", number, PIXEL_ARGB(data->state.color.a, data->state.color.r, data->state.color.g, data->state.color.b));
		  D_DEBUG_AT( Surface, "---> [num = %d] SRC:PixelFormat=0x%x \n", number, src_data->surface->config.format);
		  D_DEBUG_AT( Surface, "---> [num = %d] DST:PixelFormat=0x%x \n", number, data->surface->config.format);
		  D_DEBUG_AT( Surface, "---> [num = %d] SRC:ConfigFlags=0x%x \n", number, src_data->surface->config.flags);
		  D_DEBUG_AT( Surface, "---> [num = %d] DST:ConfigFlags=0x%x \n", number, data->surface->config.flags);	
		  D_DEBUG_AT( Surface, "---> [num = %d] SRC:caps=0x%x \n", number, src_data->surface->config.caps);
		  D_DEBUG_AT( Surface, "---> [num = %d] DST:caps=0x%x \n", number, data->surface->config.caps);			  
	 }
#endif
	...
	if(dfb_enable_dump(0))
	{
	     dfb_dump_surface(data->surface, CSBR_BACK, "blit_2_dst", number);
		 number++;
	}
#endif		  	
     return DFB_OK;
                            ...
                            int                 num )
{
...
#ifdef CC_DFB_DEBUG_SUPPORT
     static int number = 0;
	 if(dfb_enable_dump(2))
	 {
	      dfb_dump_surface(src_data->surface, CSBR_FRONT, "batchblit_src", number);
		  dfb_dump_surface(data->surface, CSBR_BACK, "batchblit_1_dst", number);
		  D_DEBUG_AT( Surface, "---> [num = %d] SRC[%p] DST[%p] \n", number, src_data->surface, data->surface);
		  D_DEBUG_AT( Surface, "---> [num = %d] blittingflags=0x%x \n", number, data->state.blittingflags);
		  D_DEBUG_AT( Surface, "---> [num = %d] src_blend=0x%x \n", number, data->state.src_blend);
		  D_DEBUG_AT( Surface, "---> [num = %d] dst_blend=0x%x \n", number, data->state.dst_blend);
	...
	if(dfb_enable_dump(2))
	{
		  dfb_dump_surface(data->surface, CSBR_BACK, "batchblit_2_dst", number);
		  number++;
	}
#endif
                             ...
                             int                 num )
{
	 ...
	 if(dfb_enable_dump(2))
	 {
	      dfb_dump_surface(src_data->surface, CSBR_FRONT, "batch2blit_src", number);
		  dfb_dump_surface(data->surface, CSBR_BACK, "batch2blit_1_dst", number);
		  D_DEBUG_AT( Surface, "---> [num = %d] SRC[%p] DST[%p] \n", number, src_data->surface, data->surface);
		  D_DEBUG_AT( Surface, "---> [num = %d] blittingflags=0x%x \n", number, data->state.blittingflags);
		  D_DEBUG_AT( Surface, "---> [num = %d] src_blend=0x%x \n", number, data->state.src_blend);
		  D_DEBUG_AT( Surface, "---> [num = %d] dst_blend=0x%x \n", number, data->state.dst_blend);
	...
	if(dfb_enable_dump(2))
	{
		 dfb_dump_surface(data->surface, CSBR_BACK, "batch2blit_2_dst", number);
                              ...
                              const DFBRectangle *destination_rect )
{
...
#ifdef CC_DFB_DEBUG_SUPPORT
     static int number = 0;
	 if(dfb_enable_dump(1))
	 {
	      dfb_dump_surface(src_data->surface, CSBR_FRONT, "stretchblit_src", number);
		  dfb_dump_surface(data->surface, CSBR_BACK, "stretchblit_1_dst", number);
		  D_DEBUG_AT( Surface, "---> [num = %d] SRC[%p] DST[%p] \n", number, src_data->surface, data->surface);
		  D_DEBUG_AT( Surface, "---> [num = %d] blittingflags=0x%x \n", number, data->state.blittingflags);
		  D_DEBUG_AT( Surface, "---> [num = %d] src_blend=0x%x \n", number, data->state.src_blend);
		  D_DEBUG_AT( Surface, "---> [num = %d] dst_blend=0x%x \n", number, data->state.dst_blend);
	 ...
	 if(dfb_enable_dump(1))
	 {
	     dfb_dump_surface(data->surface, CSBR_BACK, "stretchblit_2_dst", number);
	     number++;
	 }
#endif
