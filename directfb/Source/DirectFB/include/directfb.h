...
#define CC_DFB_SUPPORT_VDP_LAYER
#endif
...
typedef enum {
     ...
     DSCAPS_ALL			 = 0xFF1313F7,	/* All of these. */
...
#define DSCAPS_FROM_VIDEO(x)  ((x&DSCAPS_FROM_FBM)||         \
                                (x&DSCAPS_FROM_JPEG_VDP)||   \
                                (x&DSCAPS_3D_CROP_OFFSET)||  \
                                (x&DSCAPS_PRIMARY)||         \
                                (x&DSCAPS_FOUCE_VIDEOONLY)|| \
                                (x&DSCAPS_SHARED)||          \
                                (x&DSCAPS_FROM_MPEG)||       \
                                (x&DSCAPS_FROM_3DMM))       
#else
...
#define SURFACE_TYPE_VIDEO      (CSTF_LAYER|CSTF_WINDOW|CSTF_CURSOR|CSTF_SHARED)
#endif
...
extern void mt53_fill_rect(unsigned int u4_addr,unsigned int u4_pitch,unsigned int u4_h);
...
extern void system_hide_logo(void);
#ifdef __cplusplus
}
#endif
